...
class _App(httpops.HttpOperations_Mixin, _validate.Validate_Mixin):
    ...
    def find_project(self, projectname_or_uri: str, include_archived: bool = False) -> Optional[_project._Project]: ...
    def is_uri(self, name_or_uri: str) -> bool: ...
    def list_projects(self) -> List[Dict[str, str | Dict[str, Any]]]: ...
    def report_type_system(self) -> str: ...
    
    def get_query_capability_uri(self, resource_type: Optional[str] = None, context: Optional[_App] = None) -> str: ...
    def get_query_capability_uris(self, resource_type: Optional[str] = None, context: Optional[_App] = None) -> Dict[str, str]: ...
    def get_query_capability_uri_from_xml(self, capabilitiesxml: ET.ElementTree, resource_type: str, context: Optional[_App]) -> str: ...
    def get_query_capability_uris_from_xml(self, capabilitiesxml: ET.ElementTree, context: Optional[_App]) -> Dict[str, str]: ...
    ...
    def get_factory_uris_from_xml(self, factoriesxml: ET.ElementTree, context: Optional[_App]) -> Dict[str, str]: ...
