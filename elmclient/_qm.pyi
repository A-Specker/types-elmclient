...
class QMProject(_project._Project, _qmrestapi.QM_REST_API_Mixin, resource.Resources_Mixin):
    ...
    def __init__(self, name: str, project_uri: str, app: Type[_app.App], is_optin: bool = False, singlemode: bool = False, defaultinit: bool = True) -> None: ...
    ...
    def find_local_component(self, name_or_uri: str) -> Optional[Type[QMComponent]]: ...
    ...
    def resourcetypediscriminator(self, resource_x: Any) -> Type[resource.Resource]: ...
