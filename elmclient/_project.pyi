...
class _Project(oslcqueryapi._OSLCOperations_Mixin, _typesystem.Type_System_Mixin, httpops.HttpOperations_Mixin):
    ...
    component_project: Optional[Type[Project]]
    ...
    def get_query_capability_uri(self, resource_type: Optional[str] = None, context: Optional[Type[_Project]] = None) -> str: ...
    def get_query_capability_uris(self, resource_type: Optional[str] = None, context: Optional[Type[_Project]] = None) -> Dict[str, str]: ...
    
    @overload
    def get_factory_uri(self, resource_type: Optional[str] = None, context: Optional[Type[_Project]] = None, return_shapes: bool = False) -> str: ...
    @overload
    def get_factory_uri(self, resource_type: Optional[str] = None, context: Optional[Type[_Project]] = None, return_shapes: bool = True) -> Tuple[str, List[str]]: ...
    def get_factory_uri(self, resource_type: Optional[str] = None, context: Optional[Type[_Project]] = None, return_shapes: bool = False) -> Union[str, Tuple[str, List[str]]]: ...
    
    def get_factory_uris(self, resource_type: Optional[str] = None, context: Optional[Type[_Project]] = None) -> Dict[str, str]: ...
